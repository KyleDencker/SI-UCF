...
public class GameOver implements Screen {
	...
	public GameOver(GameHandler g, int launchCount, float timeTaken) {
		game = g;

		game.addNewSCore("Player", launchCount, timeTaken);
		System.out.println(game.prefs.getString("scores"));
	}
